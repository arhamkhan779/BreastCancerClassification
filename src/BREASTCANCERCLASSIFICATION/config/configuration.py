from BREASTCANCERCLASSIFICATION.constants import *
from BREASTCANCERCLASSIFICATION.utils.common import read_yaml,create_directories
from BREASTCANCERCLASSIFICATION.entity.config_entity import DataIngstionConfig,PrepareBaseModelConfig,TrainingConfig
import os
...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        training_config=TrainingConfig(
            results=Path(training.training_results_path),
