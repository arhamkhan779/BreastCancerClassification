...
from BREASTCANCERCLASSIFICATION.entity.config_entity import DataIngstionConfig
import kaggle
...
class DataIngestion:
    ...
    def download_file(self) -> str:
        ...
        try:
            ...
            original_zip_path = os.path.join(zip_download_dir, 'breast-ultrasound-images-dataset.zip')
